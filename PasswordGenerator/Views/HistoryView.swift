...
struct HistoryView: View {
    ...
    private func delete(at offsets: IndexSet) {
        withAnimation {
            ...
            HapticManager.shared.triggerMediumImpact()  // Haptic feedback when deleting
        }
    }
    ...
    private func clearHistory() {
        withAnimation {
            ...
            HapticManager.shared.triggerHeavyImpact()  // Haptic feedback for clear history
        }
    }
        ...
        ZStack {
            ...
            VStack {
                ...
                if !passwordModel.history.isEmpty {
                    ...
                    List {
                        ForEach(passwordModel.history.indices, id: \.self) { index in
                            let savedPassword = passwordModel.history[index]
                    ...
                    .scrollContentBackground(.hidden) // Hide default background in iOS 16+
